        ...
        <div className="relative mx-auto flex min-h-[calc(100vh-4rem)] max-w-7xl flex-col justify-end px-4 pb-14 pt-24 sm:px-6 lg:px-8">
          <div data-gsap-reveal className="max-w-4xl">
            ...
            <p className="mt-6 max-w-2xl text-base leading-8 text-white/86 sm:text-lg">
              HBMS Hotel là hệ thống đặt phòng và quản lý lưu trú được xây dựng
              để mang lại trải nghiệm nhanh, rõ ràng và đáng tin cậy từ lúc tìm
              phòng đến khi hoàn tất kỳ nghỉ.
            </p>
        ...
        <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          <div data-gsap-reveal>
            ...
            <p className="mt-5 text-base leading-8 text-slate-600 dark:text-slate-300">
              HBMS không chỉ là một website đặt phòng. Đây là một trải nghiệm
              vận hành khách sạn trọn vẹn: khách hàng tìm phòng nhanh, nhận
              thông tin minh bạch; nhân viên quản trị booking, phòng, dịch vụ và
              đánh giá trong một hệ thống thống nhất.
            </p>
          ...
          >
            ...
            <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-slate-950/86 to-transparent p-6 text-white">
              <div className="flex items-center gap-2 text-sm font-semibold">
                ...
                Không gian lưu trú hiện đại, vận hành bằng dữ liệu thời gian
                thực
              </div>
            </div>
          </div>
      ...
      <section className="px-4 py-20 sm:px-6 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          ...
          <div data-gsap-reveal data-gsap-delay="0.08">
            ...
            <p className="mt-5 text-base leading-8 text-slate-600 dark:text-slate-300">
              Từ giao diện tìm phòng cho khách đến dashboard quản trị, HBMS đặt
              mục tiêu giảm thao tác thừa, tăng tốc độ phục vụ và giữ mọi thông
              tin quan trọng trong tầm kiểm soát.
            </p>
            <div className="mt-8 flex flex-wrap gap-3">
              <Link
                href="/rooms"
