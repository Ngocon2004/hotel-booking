...
export default function Footer() {
  return (
    <footer className="bg-slate-950 text-gray-100 mt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 grid gap-8 md:grid-cols-4">
        ...
        <div className="md:col-span-2 space-y-4">
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="text-2xl font-black">
              HBMS<span className="text-blue-300"> Hotel</span>
            </span>
          </Link>
        ...
        <div className="space-y-3">
          <h3 className="font-bold text-blue-300">Khám phá</h3>
          <ul className="space-y-2 text-sm text-gray-400">
            <li><Link href="/" className="hover:text-blue-300 transition-colors">Trang chủ</Link></li>
            <li><Link href="/rooms" className="hover:text-blue-300 transition-colors">Phòng & Suite</Link></li>
            <li><Link href="/search" className="hover:text-blue-300 transition-colors">Tìm phòng</Link></li>
        ...
        {/* Contact */}
        <div className="space-y-3">
          <h3 className="font-bold text-blue-300">Liên hệ</h3>
          <ul className="space-y-2 text-sm text-gray-400">
